				...
				foreach (char c in s)
				{
                    ...
                    case '1':
                        m = new Mosaico("mosaico_" + c.ToString(),
                                         new Rectangle(xPos * anchoMosaico, yPos * altoMosaico,
                                                        anchoMosaico, altoMosaico), adminContenido, 1);
                        mosaicos.Add(m);
                        break;
                    case '2':
                        m = new Mosaico("mosaico_" + c.ToString(),
                                         new Rectangle(xPos * anchoMosaico, yPos * altoMosaico,
                                                        anchoMosaico, altoMosaico), adminContenido, 2);
                        mosaicos.Add(m);
                        break;
                    case '3':
                        m = new Mosaico("mosaico_" + c.ToString(),
                    ...
                    case '6':
                        m = new Mosaico("mosaico_" + c.ToString(),
                                         new Rectangle(xPos * anchoMosaico, yPos * altoMosaico,
                                                        anchoMosaico, altoMosaico), adminContenido, 3);
                        mosaicos.Add(m);
                        break;
                    case '7':
                        m = new Mosaico("mosaico_" + c.ToString(),
